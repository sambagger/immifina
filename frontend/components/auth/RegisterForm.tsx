    ...
    <Card variant="glass" className="w-full max-w-md rounded-2xl p-6 md:p-8">
      ...
      <form className="mt-8 space-y-4" onSubmit={onSubmit} noValidate>
        <div>
          ...
          />
          {fieldErrors.name ? (
            <p id="err-name" className="mt-1 text-sm font-medium text-red-400" role="alert">
              {fieldErrors.name}
            </p>
          ) : null}
        </div>
        <div>
          ...
          />
          {fieldErrors.email ? (
            <p id="err-email" className="mt-1 text-sm font-medium text-red-400" role="alert">
              {fieldErrors.email}
            </p>
          ) : null}
        </div>
        <div>
          ...
          {fieldErrors.password ? (
            <p id="err-password" className="mt-1 text-sm font-medium text-red-400" role="alert">
              {fieldErrors.password}
            </p>
          ) : null}
        </div>
        <div>
          ...
          {fieldErrors.confirmPassword ? (
            <p id="err-confirm" className="mt-1 text-sm font-medium text-red-400" role="alert">
              {fieldErrors.confirmPassword}
            </p>
          ) : null}
        </div>
