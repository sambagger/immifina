...
const btnSecondary =
  "inline-flex min-h-[44px] items-center justify-center rounded-control border border-white/20 bg-white/[0.07] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-white/[0.12] hover:border-white/30 active:scale-[0.98] focus-visible:focus-ring";
    ...
    <div className="space-y-8">
      <div>
        ...
        <div className="mt-4">
          ...
          <details className="details-disclosure mt-3 rounded-control border border-white/10 bg-white/5 p-3 text-left">
      ...
      <Card>
        ...
        <ol className="mt-4 space-y-4">
          {nextSteps.map((s, i) => (
            <li
              key={`${s.href}-${i}`}
              className="rounded-control border border-white/10 bg-white/5 p-4"
            >
