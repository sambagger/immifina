...
export function DashboardShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative z-0 flex min-h-screen flex-col md:flex-row md:pl-56">
      <aside className="hidden w-56 shrink-0 flex-col border-r border-border/80 bg-surface/95 backdrop-blur-md md:fixed md:inset-y-0 md:left-0 md:flex">
        <div className="border-b border-border p-4">
          <BrandLogo href="/dashboard" className="text-lg font-semibold tracking-tight text-accent">
            ImmiFina
          </BrandLogo>
        </div>
      ...
      <div className="flex min-h-screen flex-1 flex-col pb-20 md:pb-0">
        <header className="flex items-center justify-between border-b border-border/80 bg-surface/95 px-4 py-3 backdrop-blur-md sm:px-6 md:hidden lg:px-8">
          <BrandLogo href="/dashboard" className="text-lg font-semibold tracking-tight text-accent">
            ImmiFina
          </BrandLogo>
          <LanguageSwitcher />
        ...
        <div className="mt-auto space-y-3 border-t border-border bg-surface px-4 py-4 sm:px-6 lg:px-8">
